...
function parkFactorsHTML(){
  ...
  return `<p class="pmeta">How much each field's offensive environment differs from that year's league
    ...
    Regular season game's official final score; every other column only from games with individual box
    scores (2020 on) and needs ${PARK_MIN_G}+ such games on its own. Needs ${PARK_MIN_G}+ games at that
    field to appear at all.</p>
